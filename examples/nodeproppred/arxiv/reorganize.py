...
def greedy_algorithm(sorted_degree_path, reverse_sorted_degree_path, working_set_path, num_nodes, threshold=100, low=10):
    sorted_degree_file = open(sorted_degree_path, "r")
    reverse_sorted_degree_file = open(reverse_sorted_degree_path, "r")
    working_set_file = open(working_set_path, "r")

    sorted_degree_lines = sorted_degree_file.readlines()
    working_set_lines = working_set_file.readlines()
    reverse_sorted_degree_lines = reverse_sorted_degree_file.readlines()
    ...
    for i, degree_line in enumerate(reverse_sorted_degree_lines):
        degree = list(map(int, degree_line.strip().split(" ")))
    ...
    sorted_degree_file.close()
    working_set_file.close()
    reverse_sorted_degree_file.close()
